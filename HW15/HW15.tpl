<!DOCTYPE html>
{if !isset($smarty.get.id) or !isset($smarty.get.action) == 'delete'}
<html lang="en">
    <head>
        <meta charset="utf-8">
    ...
    <body style="width:99%; ">
        <div class="container">
            <div class="row">
                <h4 align="center"><div id="container"></div></h4>
            </div>
        </div>
        <div class="row">
            <div class="col-md-5">
                ...
                <form class="form-horizontal" method="POST" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            ...
                            {if isset($smarty.get.id)}<a href="HW15.php" class="btn btn-primary btn-lg active" role="button">Назад на главную</a>{/if}
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="col-md-7">
                {if !isset($smarty.get.id)}{include file='table.tpl_1.html'}{/if}
            </div>
        </div>
